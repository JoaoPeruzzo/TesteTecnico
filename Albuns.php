<?php
$data=json_decode(file_get_contents("https://jsonplaceholder.typicode.com/albums"));
?>
<!DOCTYPE html>
<html>
<head>   
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/TesteJoao/Postagens.php"><strong>Postagens</strong></a>
      </li>
      <li class="nav-item">
        <a class="nav-link">Albuns</a>
      </li>
      <li class="nav-item">
